...
class SwipeHelperCallback : ItemTouchHelper.Callback() {
    ...
    private fun getView(viewHolder: RecyclerView.ViewHolder): View {
        return (viewHolder as PreviousReservationListAdapter.ReservationListViewHolder).getSwipeView()
    }

    private fun getDeleteView(viewHolder: RecyclerView.ViewHolder): View {
        return (viewHolder as PreviousReservationListAdapter.ReservationListViewHolder).getBtnDelete()
    }
